...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/oleeecoin-project/oleeecoin>";
    const std::string URL_WEBSITE = "<https://oleeecoin.org>";
