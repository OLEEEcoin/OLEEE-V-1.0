...
{
    const char* pszTimestamp = "Oleee was made Jul/13 for mining in future";
    const CScript genesisOutputScript = CScript() << ParseHex("039182750fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1626203766, 2000118890, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfbd4b52aa63d8e691dcf93d49335ce9aca8542bc75afbaeb1649ed0a77da9071"));
        assert(genesis.hashMerkleRoot == uint256S("0xd51ff5766dbf5a47d0560033dc61a8a8ddefff73f119c4a60b861a8fa04a61b0"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("138.197.153.197", "138.197.153.197", true));
        // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("oleeecointools.com", "dnsseed.oleeecointools.com"));
        // vSeeds.push_back(CDNSSeedData("oleeecoinpool.org", "dnsseed.oleeecoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xfbd4b52aa63d8e691dcf93d49335ce9aca8542bc75afbaeb1649ed0a77da9071"))
        ...
        chainTxData = ChainTxData{
            ...
            1626203766, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1626203766, 1008273, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4090da0d816bed8e3de88f644e486dba2d293d8efb48b060002b5d33ebc42269"));
        assert(genesis.hashMerkleRoot == uint256S("0xd51ff5766dbf5a47d0560033dc61a8a8ddefff73f119c4a60b861a8fa04a61b0"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("138.197.153.197", "138.197.153.197"));
        // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.oleeecoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x4090da0d816bed8e3de88f644e486dba2d293d8efb48b060002b5d33ebc42269")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1626203766, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x2fe5303c967703e186d5980801ad3416a2a9ec0541bbbf63d3f5a8f4b9ea584d"));
        assert(genesis.hashMerkleRoot == uint256S("0xd51ff5766dbf5a47d0560033dc61a8a8ddefff73f119c4a60b861a8fa04a61b0"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x2fe5303c967703e186d5980801ad3416a2a9ec0541bbbf63d3f5a8f4b9ea584d"))
        };
