...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s oleeecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  oleeecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oleeecoin transaction") + "\n" +
              "  oleeecoin-tx [options] -create [commands]   " + _("Create hex-encoded oleeecoin transaction") + "\n" +
              "\n";
